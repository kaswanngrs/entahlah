...
<head>
    ...
    <title>Nmnom Educational Platform</title>
                    ...
                    <tr>
                        <td align="center"
                            ...
                            <div style="line-height: 35px">
                                ...
                                We welcome you to <span style="color: #9c27b0;">Sayd Aostra icons</span>
                        ...
                        <tr>
                            <td align="center">
                                <table border="0" width="300" align="center" cellpadding="0" cellspacing="0"
                                    bgcolor="333333" style="border: 3px solid #333333; ">
                                    <tr>
                                        <td align="center"
                                            style="color: #ffffff; font-size: 15px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;  line-height: 32px;">
                                            Verification Code:
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <tr>
                            <td align="center">
                                <table border="0" width="590" align="center" cellpadding="0" cellspacing="0"
                                    bgcolor="ffffff" class="container590" style="border: 3px solid #333; ">
                                        ...
                                        <td align="center">
                                            <table border="0" width="540" align="center" cellpadding="0" cellspacing="0"
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="30">&nbsp;</td>
                                                    <td align="center"
                                                        style="color: #333333; font-size: 18px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 32px;">

                                                        <div style="line-height: 32px">
                                                            Verification Code: <span
                                                                style="color: #9c27b0; text-decoration: none;">{{ $token }}</span>
                                                        </div>
